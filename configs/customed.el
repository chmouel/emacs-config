...
(custom-set-variables
 ...
 '(package-selected-packages
   '(poly-org poly-slim poly-markdown polymode cyphejor pinyinlib counsel-tramp counsel-world-clock counsel-osx-app ivy-xref ivy-yasnippet ivy-hydra ivy-prescient amx counsel-projectile company-prescient yasnippet-snippets fzf evil-numbers company-box drag-stuff all-the-icons-ivy all-the-icons-ivy-rich lsp-ivy lsp-treemacs yapfify bufler python-black eshell-toggle eshell-did-you-mean go-dlv olivetti dired-sidebar anaconda-mode blacken closql company dash-functional emacsql hydra lsp-mode magit-popup yasnippet minibuffer company-quickhelp mustache-mode github-review all-the-icons-ibuffer all-the-icons-gnus go-test sqlite magit-section jinja2-mode ripgrep grip-mode zoom-mode emojify doom-themes centaur-tab awesome-tab all-the-icons-dired all-the-icons exec-path-from-shell ace-window dashboard jira-markup-mode lsp-ui py-isort subr-x docker-tramp ibuffer-tramp kubernetes-tramp helm-org general direnv pytest ibuffer-git esh-autosuggest diredfl evil monokai-pro monokai-alt monokai-pro-theme monokai-theme goto-last-change jsx-mode auto-complete multiple-cursors ag deadgrep gitconfig-mode yaml-imenu yaml-mode counsel flycheck-rust rust-auto-use rust-playground rust-mode reformatter multi-compile-run multi-compile yapf-mode yapf crux adoc color-moccur github-issues direx lorem-ipsum pyimport flycheck-plantuml plantuml-mode indent-guide evil-matchit-mode elisp emacs-lisp elisp-mode emacs-lisp-mode info-colors magithub shell-mode message isearch abbrev dired dired-x lisp-mode misc anzu page diminish ns-win moe popup-kill-ring pdf-tools imenu-list github-clone indent-tools helm-lean applescript-mode browse-at-remote go-impl dumb-jump groovy-mode the-org-mode-expansions flycheck-yamllint avy commenter gist zop-to-char js2-mode jsfmt go-add-tags wgrep-ag flycheck-gometalinter go-stacktracer js-auto-beautify highlight-indentation esqlite go-errcheck go-snippets go-playground golint go-rename toggle-quotes zygospore window-number wgrep web use-package try smex smart-shift smart-mode-line rpm-spec-mode request-deferred regex-tool queue python-docstring pyfmt pcsv pcache paredit package-safe-delete message-x marmalade magit-find-file json-rpc json-mode isearch-dabbrev ido-vertical-mode ido-completing-read+ ibuffer-vc hungry-delete highlight-numbers highlight-80+ google-this go-eldoc github-browse-file fringe-helper flycheck flx-ido find-file-in-git-repo expand-region dropdown-list dockerfile-mode csv-mode csharp-mode company-go company-anaconda comment-dwim-2 browse-kill-ring boxquote bm aggressive-indent))
 '(package-user-dir
   (expand-file-name
