...
(custom-set-faces
 ...
 '(log-view-message ((((class color) (background light)) (:background "grey" :foreground "red"))))
 '(magit-diff-add ((((class color) (background light)) (:foreground "white" :weight bold))))
 '(magit-diff-del ((((class color) (background light)) (:foreground "pink"))))
