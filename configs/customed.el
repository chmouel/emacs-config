...
(custom-set-variables
 ...
 '(*pastie-restricted* t)
 '(ac-comphist-file (expand-file-name (concat user-emacs-directory "/auto-save-list/ac-comphist.dat")))
 '(ac-dictionary-directories (quote ((expand-file-name (concat user-emacs-directory "/dict")))))
 '(ac-dictionary-files (quote ((expand-file-name (concat user-emacs-directory "/packages/auto-complete/dict/")))))
 ...
 '(bc-bookmark-file (expand-file-name (concat user-emacs-directory "/auto-save-list/breadcrumb.el")))
 ...
 '(eshell-directory-name (expand-file-name (concat user-emacs-directory "/auto-save-list/eshell/")))
 '(eshell-modules-list
   (quote
 ...
 '(gnus-init-file (expand-file-name (concat user-emacs-directory "/gnus/init.el")))
 ...
 '(ido-save-directory-list-file (expand-file-name (concat user-emacs-directory "/auto-save-list/ido.last")))
 ...
 '(mc/list-file (expand-file-name (concat user-emacs-directory "/auto-save-list/mc-lists.el" t)))
 ...
 '(oauth2-token-file (expand-file-name (concat user-emacs-directory "/auto-save-list/oauth2.plstore")))
 ...
 '(projectile-cache-file (expand-file-name (concat user-emacs-directory "/auto-save-list/projectile.cache")))
 '(projectile-keymap-prefix "")
 '(projectile-known-projects-file (expand-file-name (concat user-emacs-directory "/auto-save-list/projectile-bookmarks.eld")))
 ...
 '(recent-addresses-file (expand-file-name (concat user-emacs-directory "/auto-save-list/recent-addresses")))
 '(recentf-auto-cleanup (quote mode))
 '(recentf-exclude
   (quote
    (".*/\\.news.*" ".*/\\.bbdb.*" ".*bookmarks.bmk.*" "/usr/share/emacs/.*/etc/.*" ".*loaddefs.el$")))
 '(recentf-mode t)
 '(recentf-save-file (expand-file-name (concat user-emacs-directory "/auto-save-list/recent-file-list.el")))
 '(regex-tool-backend (quote perl))
 '(request-storage-directory (expand-file-name (concat user-emacs-directory "/auto-save-list/request")))
 '(require-final-newline (quote visit-save))
 '(rst-level-face-base-color "dark slate gray")
 '(safe-local-variable-values (quote ((c-hanging-comment-ender-p))))
 '(save-interprogram-paste-before-kill t)
 '(save-place-file (expand-file-name (concat user-emacs-directory "/auto-save-list/emacs-places")))
 '(save-place-mode t nil (saveplace))
 '(savehist-file (expand-file-name (concat user-emacs-directory "/auto-save-list/history")))
 '(savehist-mode t)
 '(server-use-tcp nil)
 '(server-window nil)
 '(smex-save-file (expand-file-name (concat user-emacs-directory "/auto-save-list/smex-items")))
 ...
 '(tramp-persistency-file-name (expand-file-name (concat user-emacs-directory "/auto-save-list/tramp")) nil (tramp))
 '(url-cookie-file (expand-file-name (concat user-emacs-directory "/auto-save-list/cookies")))
 '(use-file-dialog nil)
